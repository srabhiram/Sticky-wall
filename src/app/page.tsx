...
export default function Home() {
  return (
   ...
   <main className="min-h-screen w-full flex flex-col items-center justify-center bg-lime-50">
    ...
    <p className="text-[1rem] md:text-[2rem] font-semibold font-playwrite">A Task manager for your Daily life!</p>
    <Link href={`/signup`} className="mt-3 px-3 py-2 font-semibold md:text-xl bg-lime-400 rounded-md hover:bg-lime-300 active:bg-lime-500">Get Started</Link>
