...
export default function Spinner() {
  return (
    <div className="h-dvh bg-white/30 w-full flex items-center justify-center">
      <div><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" preserveAspectRatio="xMidYMid" width="200" height="200" style={{
      shapeRendering: "auto",
      display: "block",
...
<circle fill-opacity="0.875" fill="#9dff72" r="6" cy="0" cx="0">
...
<circle fill-opacity="0.75" fill="#9dff72" r="6" cy="0" cx="0">
...
<circle fill-opacity="0.625" fill="#9dff72" r="6" cy="0" cx="0">
...
<circle fill-opacity="0.5" fill="#9dff72" r="6" cy="0" cx="0">
...
<circle fill-opacity="0.375" fill="#9dff72" r="6" cy="0" cx="0">
...
<circle fill-opacity="0.25" fill="#9dff72" r="6" cy="0" cx="0">
...
<circle fill-opacity="0.125" fill="#9dff72" r="6" cy="0" cx="0">
